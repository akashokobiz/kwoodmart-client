...
const ThankYou = () => {
  ...
  return (
    <>
      ...
      <div className="pt-24 md:pt-36 lg:pt-40 2xl:pt-40 md:pb-14 flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 p-4 lg:py-20">
        <div className="bg-white shadow-lg rounded-2xl p-8 max-w-md text-center space-y-6  lg:mt-0">
          <Lottie
