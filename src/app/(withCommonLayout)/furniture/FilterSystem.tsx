...
export default function FilterSystem({
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="sticky top-0 bg-white border-b border-gray-200 py-4 z-40">
      ...
      <div className=" mx-auto py-4 lg:py-8">
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 md:gap-4 lg:gap-4">
