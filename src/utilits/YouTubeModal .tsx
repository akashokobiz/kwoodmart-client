    ...
    return (
        <>
            <button
                ...
                className="relative group cursor-pointer w-full h-40 sm:h-64 md:h-64 2xl:h-80"
            >
            ...
            {open && createPortal(
                ...
                >
                    <div
                        className="bg-white p-4 rounded-md shadow-xl max-w-3xl w-full relative mx-4"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <button
                            onClick={() => setOpen(false)}
                            className="absolute cursor-pointer top-2 right-3 text-red-500 hover:text-red-700 p-2 rounded-full bg-white shadow-md hover:shadow-lg transition z-10"
                        >
