  ...
  return (
    <div className="relative bg-gray-100">
      <div className="max-w-7xl mx-auto">
        <div className="py-4 px-4 md:px-6 lg:px-8 2xl:mx-4">
          <div className=" flex flex-col lg:flex-row justify-between space-y-5">
            <div>
              ...
              <div className="text-black text-md lg:text-lg flex flex-col space-y-1">
                ...
                <div>
                  Address: Santarkul Road, West Padardia, Lane No. 4,
                  <br />
                  Baitul Mamur Masjid Road, House No. 60, <br />
                  Badda Dhaka- 2941. <br />
            ...
            <div>
              ...
              <div className="">
                <div className="flex lg:justify-center lg:items-center gap-2 mt-4">
                  <a
                    href="https://www.facebook.com/share/17sg2TrMrE/"
                    target="_blank"
        ...
        <div className="px-4 md:px-6 lg:px-8 text-center py-4 border-t">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div>
              Copyright © 2025 K.WOOD MART All Right Reserved.
            </div>
            <div>
              Developed by{" "}
