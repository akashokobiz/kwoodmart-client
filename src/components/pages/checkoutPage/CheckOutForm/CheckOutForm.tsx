      ...
      <form onSubmit={handleSubmit(onSubmit)}>
            ...
            render={({ field }) => (
              <>
                <div className="flex gap-4">
                  ...
                  <label
                    className={`flex items-center gap-2 cursor-pointer border p-2 rounded-md  hover:border-blue-400 duration-500 hover:shadow-blue-200 hover:scale-99 ${field.value === "ssl_card"
                      ? "border-blue-500"
                      : "border-gray-300"
                      }`}
                  >
        ...
        <div className="mt-6 border border-[#D4A373]/30 rounded-xl p-4 bg-gradient-to-br from-white to-[#fefaf6] shadow-sm">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <select
              className="border border-black/20 p-2 rounded-md focus:border-[#D4A373] focus:ring-1 focus:ring-[#D4A373] outline-none text-sm cursor-pointer"
              value={emiMonths}
              onChange={(e) => {
            ...
            >
              <option className="cursor-pointer" value="">No EMI (Full Payment)</option>
